...
class SegmentControl extends React.Component {
  ...
  render() {
    ...
    const { height } = this.state.segmentDimension
            ...
            style={[
              {
                ...
                width: this.state.segmentDimension.width,
                translateX: this.state.positionAnimationValue,
                translateY: this.state.activeSegmentPosition.y
              },
              styles.segment,
...
SegmentControl.propTypes = {
  ...
  /**
   * Active Segment's offset height.
   */
